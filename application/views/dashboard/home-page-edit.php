	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				...
				<li>Home Page</li>
				<li>Info Box </li>
				<li class="active">Update Info Box </li>
			</ol>
		</div><!--/.row-->
			...
			<div class="col-lg-12">
				...
				<div class="panel panel-primary">
					<div class="panel-heading">Update Website Upper Infobox</div>
					<div class="panel-body">
					 	<form class="form-horizontal" method="POST" enctype="multipart/form-data">
					 	<input type="hidden" name="id" value="<?=$_GET['id']?>"/>
								<div class="form-group">
									<label class="col-md-5 control-label" for="info_image">Select Image </label>
									<div class="col-md-7">
								...
								<div class="form-group">
									<label class="col-md-5 control-label" for="meta_keywords">Meta Keywords for Image </label>
									<div class="col-md-7">
										<input id="meta_keywords" name="meta_keywords" type="text" class="form-control" placeholder="Meta Keywords">
								...
								<div class="form-group">
							 	...
							 	<div class="form-group">
									...
									<div class="col-md-7">
										<button type="submit" name="btn_update_infobox" class="btn btn-primary">
											Update Infobox
										</button>
									</div>
								</div>

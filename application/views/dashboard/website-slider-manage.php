	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active"><?=$web_s_title?></li>
				<li class="active"><?=$web_s_title2?></li>
			</ol>
		</div><!--/.row-->
...
?>
			...
			<div class="panel panel-primary">
					<div class="panel-heading"><?=$web_s_title?></div>
					<div class="panel-body">
						
						<form class="form-horizontal" method="POST" >
						 		 <div class="form-group">
									<label class="col-md-3 control-label" for="headings"><?=$web_s_heading?></label>
									<div class="col-md-9">
										<input id="headings" name="headings" type="text" placeholder="<?=$web_s_heading_p?>" class="form-control">
									</div>
								</div>
											
								<div class="form-group">
									<label class="col-md-3 control-label" for="descriptions"><?=$web_s_discription?></label>
									<div class="col-md-9">
										<textarea id="descriptions" name="descriptions" placeholder="<?=$web_s_discription_p?>" class="form-control"></textarea>
									</div>
								</div>
					...
					<div class="panel-body">
						<table data-toggle="table" data-url="tables/data1.json"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="asc">
						    ...
						    <tr>
						        ...
						        <th data-field="Headings" data-sortable="true"><?=$tbl_sr_no?></th>
						        <th data-field="Description"  data-sortable="true"><?=$tbl_discription?></th>
